...
const ApplyJob = () => {
  ...
  const uid = useSelector((u) => u.user.id);
  ...
  const saveApplyJob = (e) => {
    ...
    // fd.append("can", JSON.stringify(candidate));
    fd.append("fullName", candidate.fullName);
    fd.append("email", candidate.email);
    fd.append("mobNo", candidate.mobNo);
    fd.append("experience", candidate.experience);
    fd.append("technicalSkill", candidate.technicalSkill);
    fd.append("interviewDate", candidate.interviewDate);
    fd.append("jobId", candidate.jobId);
